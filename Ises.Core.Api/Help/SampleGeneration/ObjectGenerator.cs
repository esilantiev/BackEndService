...
using Ises.Core.Api.Help.ModelDescriptions;

namespace Ises.Core.Api.Help.SampleGeneration
{
    /// <summary>
    ...
    public class ObjectGenerator
    {
        ...
        private static void SetPublicProperties(Type type, object obj, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            foreach (var property in properties)
            {
                ...
                {
                    var sampleAttribute = property.GetCustomAttribute<DocSampleAttribute>();
                    var propertyValue = sampleAttribute != null
        ...
        private static void SetPublicFields(Type type, object obj, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            {
                var sampleAttribute = field.GetCustomAttribute<DocSampleAttribute>();
                var fieldValue = sampleAttribute != null
                        ? sampleAttribute.Value
                        : objectGenerator.GenerateObject(field.FieldType, createdObjectReferences);
