...
namespace Ises.Core.Api.Help.Common
{
    ...
    {
        const string ApiModelPrefix = "MS_HelpPageApiModel_";
        ...
        static void GenerateRequestModelDescription(HelpPageApiModel apiModel, ModelDescriptionGenerator modelGenerator,
            HelpPageSampleGenerator sampleGenerator)
        {
            var apiDescription = apiModel.ApiDescription;
            foreach (var apiParameter in apiDescription.ParameterDescriptions)
        ...
        static bool TryGetResourceParameter(ApiDescription apiDescription, HttpConfiguration config,
